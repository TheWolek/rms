...
INSERT INTO `dishes` VALUES (1,'cheeseburger',10,'[\"grill\", \"assemble\"]',NULL,0,1),(2,'small fires',5,'[\"fries\"]',NULL,0,1),(3,'large fries',8,'[\"fries\"]',NULL,0,1),(4,'small coke',5,'[\"drink\"]',NULL,0,1),(5,'large coke',8,'[\"drink\"]',NULL,0,1),(6,'cheesebuger small set',18,NULL,'[1, 2, 4]',1,1);
...
INSERT INTO `dishesInOrders` VALUES (6,3,3,'new');
...
--
-- Temporary table structure for view `firesStationWork`
--

DROP TABLE IF EXISTS `firesStationWork`;
/*!50001 DROP VIEW IF EXISTS `firesStationWork`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `firesStationWork` (
  `dishId` tinyint NOT NULL,
  `displayName` tinyint NOT NULL,
  `id` tinyint NOT NULL,
  `dishStatus` tinyint NOT NULL
...
INSERT INTO `orders` VALUES (1,1,1,0,'done',1),(2,2,1,0,'rdy',1),(3,1,1,0,'new',0);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dpp`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `drinkStationWork` AS select `d`.`dishId` AS `dishId`,`d`.`displayName` AS `displayName`,`dio`.`id` AS `id`,`dio`.`dishStatus` AS `dishStatus` from (`dishesInOrders` `dio` join `dishes` `d` on((`dio`.`dishId` = `d`.`dishId`))) where ((json_value(`d`.`typesOfActivity`, '$' returning char(512)) like '%drink%') and (`dio`.`dishStatus` = 'new')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `firesStationWork`
--

/*!50001 DROP TABLE IF EXISTS `firesStationWork`*/;
/*!50001 DROP VIEW IF EXISTS `firesStationWork`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dpp`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `firesStationWork` AS select `d`.`dishId` AS `dishId`,`d`.`displayName` AS `displayName`,`dio`.`id` AS `id`,`dio`.`dishStatus` AS `dishStatus` from (`dishesInOrders` `dio` join `dishes` `d` on((`dio`.`dishId` = `d`.`dishId`))) where ((json_value(`d`.`typesOfActivity`, '$' returning char(512)) like '%fries%') and (`dio`.`dishStatus` = 'new')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dpp`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `friesStationWork` AS select `d`.`dishId` AS `dishId`,`d`.`displayName` AS `displayName`,`dio`.`id` AS `id`,`dio`.`dishStatus` AS `dishStatus` from (`dishesInOrders` `dio` join `dishes` `d` on((`dio`.`dishId` = `d`.`dishId`))) where ((json_value(`d`.`typesOfActivity`, '$' returning char(512)) like '%fries%') and (`dio`.`dishStatus` = 'new')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dpp`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `grillStationWork` AS select `d`.`dishId` AS `dishId`,`d`.`displayName` AS `displayName`,`dio`.`id` AS `id`,`dio`.`dishStatus` AS `dishStatus` from (`dishesInOrders` `dio` join `dishes` `d` on((`dio`.`dishId` = `d`.`dishId`))) where ((json_value(`d`.`typesOfActivity`, '$' returning char(512)) like '%grill%') and (`dio`.`dishStatus` = 'new')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-10-02 23:21:20
